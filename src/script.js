function displayPoem(response) {
  new Typewriter("#poem", {
    strings: response.data.answer.toLowerCase(),
    autoStart: true,
  });
}
...
function generatePoem(event) {
  ...
  let context =
    "You are an AI assistant knowledgeable about good poetry and bad poetry. You write only bad poetry full of cliches. You often use angsty words like midnight, darkness, despair, and sorrow.";
